export interface AutoCompleteOptions {
    ...
    itemToStringCallback?: (item: any) => string;
...
export class AutoComplete {
    ...
    onSelectCallback: (item: any) => void;
    loaderElement: HTMLElement | null;
    itemToStringCallback: ((item: any) => string) | null;
    ...
    constructor({
        ...
        this.itemToStringCallback = itemToStringCallback || null;
    ...
    async init() {
        ...
        document.addEventListener("click", (e) => {
            if (
                !this.suggestionContainer?.contains(e.target as Node) &&
...
export class MultiSelectAutoComplete extends AutoComplete {
    ...
    constructor(options: AutoCompleteOptions & { tagsContainer: HTMLElement, hiddenInputElement: HTMLInputElement }) {
