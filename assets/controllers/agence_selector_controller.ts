...
export default class extends Controller {
  ...
  agenceTarget!: HTMLSelectElement;
  serviceTarget!: HTMLSelectElement;
  hasAgenceTarget!: boolean;
  ...
  async onAgenceChange(event: Event) {
    const agenceId = (event.target as HTMLSelectElement).value;
  ...
  updateServiceOptions(services: any) {
