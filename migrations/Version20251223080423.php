 ...
 */
final class Version20251223080423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("DECLARE @ConstraintName nvarchar(200); SELECT @ConstraintName = C.name FROM sys.default_constraints C JOIN sys.tables T ON C.parent_object_id = T.object_id JOIN sys.columns O ON C.parent_column_id = O.column_id AND C.parent_object_id = O.object_id WHERE T.name = 'casier' AND O.name = 'is_valide'; IF @ConstraintName IS NOT NULL EXEC('ALTER TABLE casier DROP CONSTRAINT ' + @ConstraintName)");
        $this->addSql('ALTER TABLE casier ALTER COLUMN is_valide BIT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE casier ALTER COLUMN is_valide BIT NOT NULL');
        $this->addSql('ALTER TABLE casier ADD DEFAULT 0 FOR is_valide');
    }
}
