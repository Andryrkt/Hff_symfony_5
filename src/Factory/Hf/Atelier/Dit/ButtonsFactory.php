    ...
    public function generateEllipsisButtons(FormDto $dto): array
    {
        ...
        if ($dto->estOrASoumi) {
            $buttons[] = [
                ...
                'attributes' => 'data-bs-toggle="modal" data-bs-target="#soumissionDocModal" data-numdit="' . $dto->numeroDit . '" data-numor="' . $dto->numeroOr . '" data-action="pages--hf--atelier--dit--dit-list#prepareSoumissionModal"',
            ];
        }
