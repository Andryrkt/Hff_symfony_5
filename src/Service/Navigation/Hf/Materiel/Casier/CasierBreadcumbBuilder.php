...
namespace App\Service\Navigation\Hf\Materiel\Casier;
...
class CasierBreadcumbBuilder extends BaseBreadcrumbBuilder implements BreadcrumbBuilderInterface
{
    private $breadcrumb;
    ...
    public function supports(string $context): bool
    {
        return in_array($context, [
            'hf_materiel_casier_liste_index',
            'hf_materiel_casier_first_form_index',
            'hf_materiel_casier_second_form_index',
        ]);
    }
    ...
    public function build(array $parameters = []): array
    {
        ...
        switch ($context) {
            case 'hf_materiel_casier_first_form_index':
                $items = $this->buildFirstFormBreadcrumb();
                break;
            case 'hf_materiel_casier_second_form_index':
                $items = $this->buildSecondFormBreadcrumb();
                break;
            case 'hf_materiel_casier_liste_index':
    ...
    private function buildBaseBreadcrumb(): BreadcrumbBuilder
    {
        ...
        return $this->breadcrumb
            ...
            ->add('Casier', null, [], $this->casierSubmenu())
        ;
    }
    ...
    {
        return $this->buildBaseBreadcrumb()
            ->add("Création casier - Étape 2")
            ->setBackRoute('hf_materiel_casier_first_form_index')
            ->get();
    }
    ...
    {
        return $this->buildBaseBreadcrumb()
            ->add("Liste de consultation du casier")
            ->setBackRoute('home_index')
            ->get();
    }
}
